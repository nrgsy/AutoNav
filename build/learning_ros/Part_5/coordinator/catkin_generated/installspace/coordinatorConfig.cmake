...
if("FALSE" STREQUAL "TRUE")
  set(coordinator_SOURCE_PREFIX /home/thomas/ros_ws/src/learning_ros/Part_5/coordinator)
  set(coordinator_DEVEL_PREFIX /home/thomas/ros_ws/devel)
  ...
  set(coordinator_INSTALL_PREFIX /home/thomas/ros_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'coordinator' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'wyatt <wyatt@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'coordinator' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/thomas/ros_ws/install/${idir}'.  Ask the maintainer 'wyatt <wyatt@todo.todo>' to fix it.")
    endif()
...
set(coordinator_EXPORTED_TARGETS "")
...
set(depends "roscpp;object_finder;object_grabber;actionlib;tf;geometry_msgs;std_msgs")
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${coordinator_dep}_FOUND)
      find_package(${coordinator_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${coordinator_dep} REQUIRED ${depend_list})
  endif()
