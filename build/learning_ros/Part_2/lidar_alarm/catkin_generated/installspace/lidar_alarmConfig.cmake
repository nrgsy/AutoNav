...
if("FALSE" STREQUAL "TRUE")
  set(lidar_alarm_SOURCE_PREFIX /home/thomas/ros_ws/src/learning_ros/Part_2/lidar_alarm)
  set(lidar_alarm_DEVEL_PREFIX /home/thomas/ros_ws/devel)
  ...
  set(lidar_alarm_INSTALL_PREFIX /home/thomas/ros_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'lidar_alarm' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'wyatt <wyatt@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'lidar_alarm' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/thomas/ros_ws/install/${idir}'.  Ask the maintainer 'wyatt <wyatt@todo.todo>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${lidar_alarm_dep}_FOUND)
      find_package(${lidar_alarm_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${lidar_alarm_dep} REQUIRED ${depend_list})
  endif()
