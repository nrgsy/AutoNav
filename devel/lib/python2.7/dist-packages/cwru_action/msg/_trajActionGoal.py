...
"""autogenerated by genpy from cwru_action/trajActionGoal.msg. Do not edit."""
import sys
...
class trajActionGoal(genpy.Message):
  ...
  _type = "cwru_action/trajActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','cwru_action/trajGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.goal is None:
        self.goal = cwru_action.msg.trajGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = cwru_action.msg.trajGoal()
