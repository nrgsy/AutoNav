...
"""autogenerated by genpy from cwru_action/merry_get_canActionFeedback.msg. Do not edit."""
import sys
...
class merry_get_canActionFeedback(genpy.Message):
  _md5sum = "5a6929cb3514eabf286ff2717ef7a5a4"
  _type = "cwru_action/merry_get_canActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','cwru_action/merry_get_canFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(merry_get_canActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = cwru_action.msg.merry_get_canFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = cwru_action.msg.merry_get_canFeedback()
