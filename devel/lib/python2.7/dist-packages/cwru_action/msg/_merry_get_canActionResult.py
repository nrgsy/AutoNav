...
"""autogenerated by genpy from cwru_action/merry_get_canActionResult.msg. Do not edit."""
import sys
...
class merry_get_canActionResult(genpy.Message):
  _md5sum = "90dc34063fa72f8ddc4948d617edae4b"
  _type = "cwru_action/merry_get_canActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','cwru_action/merry_get_canResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(merry_get_canActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = cwru_action.msg.merry_get_canResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = cwru_action.msg.merry_get_canResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_i.pack(self.result.err_code))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.result.err_code,) = _struct_i.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
