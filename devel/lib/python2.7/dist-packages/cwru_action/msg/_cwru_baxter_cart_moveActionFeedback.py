...
"""autogenerated by genpy from cwru_action/cwru_baxter_cart_moveActionFeedback.msg. Do not edit."""
import sys
...
class cwru_baxter_cart_moveActionFeedback(genpy.Message):
  _md5sum = "5a6929cb3514eabf286ff2717ef7a5a4"
  _type = "cwru_action/cwru_baxter_cart_moveActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','cwru_action/cwru_baxter_cart_moveFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(cwru_baxter_cart_moveActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = cwru_action.msg.cwru_baxter_cart_moveFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = cwru_action.msg.cwru_baxter_cart_moveFeedback()
