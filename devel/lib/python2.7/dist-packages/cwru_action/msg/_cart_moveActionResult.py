...
"""autogenerated by genpy from cwru_action/cart_moveActionResult.msg. Do not edit."""
import sys
...
class cart_moveActionResult(genpy.Message):
  ...
  _type = "cwru_action/cart_moveActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','cwru_action/cart_moveResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = cwru_action.msg.cart_moveResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = cwru_action.msg.cart_moveResult()
