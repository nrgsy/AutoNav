...
"""autogenerated by genpy from cwru_action/trajAction.msg. Do not edit."""
import sys
...
class trajAction(genpy.Message):
  _md5sum = "232da7c9699332b585768d22defba609"
  _type = "cwru_action/trajAction"
...
"""
  ...
  _slot_types = ['cwru_action/trajActionGoal','cwru_action/trajActionResult','cwru_action/trajActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.action_goal is None:
        self.action_goal = cwru_action.msg.trajActionGoal()
      if self.action_result is None:
        self.action_result = cwru_action.msg.trajActionResult()
      if self.action_feedback is None:
        self.action_feedback = cwru_action.msg.trajActionFeedback()
    else:
      self.action_goal = cwru_action.msg.trajActionGoal()
      self.action_result = cwru_action.msg.trajActionResult()
      self.action_feedback = cwru_action.msg.trajActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_i3I.pack(_x.action_result.result.return_val, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_result.result.return_val, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs,) = _struct_i3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
