...
"""autogenerated by genpy from cwru_action/trajActionResult.msg. Do not edit."""
import sys
...
class trajActionResult(genpy.Message):
  _md5sum = "81348f802f6e037d8f23b2bf2a225aff"
  _type = "cwru_action/trajActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','cwru_action/trajResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(trajActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = cwru_action.msg.trajResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = cwru_action.msg.trajResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_i.pack(self.result.return_val))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.result.return_val,) = _struct_i.unpack(str[start:end])
      return self
