...
if("TRUE" STREQUAL "TRUE")
  set(hector_gazebo_plugins_SOURCE_PREFIX /home/thomas/ros_ws/src/student_code/hector_gazebo/hector_gazebo_plugins)
  set(hector_gazebo_plugins_DEVEL_PREFIX /home/thomas/ros_ws/devel)
  ...
  set(hector_gazebo_plugins_INSTALL_PREFIX /home/thomas/ros_ws/install)
...
if(NOT "/home/thomas/ros_ws/devel/include;/home/thomas/ros_ws/src/student_code/hector_gazebo/hector_gazebo_plugins/include " STREQUAL " ")
  set(hector_gazebo_plugins_INCLUDE_DIRS "")
  set(_include_dirs "/home/thomas/ros_ws/devel/include;/home/thomas/ros_ws/src/student_code/hector_gazebo/hector_gazebo_plugins/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'hector_gazebo_plugins' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Johannes Meyer <meyer@fsr.tu-darmstadt.de>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'hector_gazebo_plugins' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/thomas/ros_ws/src/student_code/hector_gazebo/hector_gazebo_plugins/${idir}'.  Ask the maintainer 'Johannes Meyer <meyer@fsr.tu-darmstadt.de>' to fix it.")
    endif()
...
set(hector_gazebo_plugins_EXPORTED_TARGETS "hector_gazebo_plugins_generate_messages_cpp;hector_gazebo_plugins_generate_messages_lisp;hector_gazebo_plugins_generate_messages_py;hector_gazebo_plugins_gencfg")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${hector_gazebo_plugins_dep}_FOUND)
      find_package(${hector_gazebo_plugins_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${hector_gazebo_plugins_dep} REQUIRED ${depend_list})
  endif()
