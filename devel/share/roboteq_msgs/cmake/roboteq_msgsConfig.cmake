...
if("TRUE" STREQUAL "TRUE")
  set(roboteq_msgs_SOURCE_PREFIX /home/thomas/ros_ws/src/student_code/roboteq_msgs)
  set(roboteq_msgs_DEVEL_PREFIX /home/thomas/ros_ws/devel)
  ...
  set(roboteq_msgs_INSTALL_PREFIX /home/thomas/ros_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'roboteq_msgs' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Mike Purvis <mpurvis@clearpathrobotics.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'roboteq_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/thomas/ros_ws/src/student_code/roboteq_msgs/${idir}'.  Ask the maintainer 'Mike Purvis <mpurvis@clearpathrobotics.com>' to fix it.")
    endif()
...
set(roboteq_msgs_EXPORTED_TARGETS "roboteq_msgs_generate_messages_cpp;roboteq_msgs_generate_messages_lisp;roboteq_msgs_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${roboteq_msgs_dep}_FOUND)
      find_package(${roboteq_msgs_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${roboteq_msgs_dep} REQUIRED ${depend_list})
  endif()
