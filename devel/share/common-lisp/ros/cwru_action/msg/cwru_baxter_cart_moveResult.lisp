...
;//! \htmlinclude cwru_baxter_cart_moveResult.msg.html

(cl:defclass <cwru_baxter_cart_moveResult> (roslisp-msg-protocol:ros-message)
  ((return_code
    :reader return_code
    :initarg :return_code
    :type cl:integer
...
(cl:defclass cwru_baxter_cart_moveResult (<cwru_baxter_cart_moveResult>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <cwru_baxter_cart_moveResult>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'cwru_baxter_cart_moveResult)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cwru_action-msg:<cwru_baxter_cart_moveResult> is deprecated: use cwru_action-msg:cwru_baxter_cart_moveResult instead.")))

(cl:ensure-generic-function 'return_code-val :lambda-list '(m))
(cl:defmethod return_code-val ((m <cwru_baxter_cart_moveResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cwru_action-msg:return_code-val is deprecated.  Use cwru_action-msg:return_code instead.")
  (return_code m))

(cl:ensure-generic-function 'err_code-val :lambda-list '(m))
(cl:defmethod err_code-val ((m <cwru_baxter_cart_moveResult>))
...
(cl:defmethod err_msg-val ((m <cwru_baxter_cart_moveResult>))
...
(cl:defmethod computed_arrival_time-val ((m <cwru_baxter_cart_moveResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cwru_action-msg:computed_arrival_time-val is deprecated.  Use cwru_action-msg:computed_arrival_time instead.")
  (computed_arrival_time m))

(cl:ensure-generic-function 'q_arm_right-val :lambda-list '(m))
(cl:defmethod q_arm_right-val ((m <cwru_baxter_cart_moveResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cwru_action-msg:q_arm_right-val is deprecated.  Use cwru_action-msg:q_arm_right instead.")
  (q_arm_right m))

(cl:ensure-generic-function 'q_arm_left-val :lambda-list '(m))
(cl:defmethod q_arm_left-val ((m <cwru_baxter_cart_moveResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cwru_action-msg:q_arm_left-val is deprecated.  Use cwru_action-msg:q_arm_left instead.")
  (q_arm_left m))

(cl:ensure-generic-function 'current_pose_gripper_right-val :lambda-list '(m))
(cl:defmethod current_pose_gripper_right-val ((m <cwru_baxter_cart_moveResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cwru_action-msg:current_pose_gripper_right-val is deprecated.  Use cwru_action-msg:current_pose_gripper_right instead.")
  (current_pose_gripper_right m))

(cl:ensure-generic-function 'current_pose_gripper_left-val :lambda-list '(m))
(cl:defmethod current_pose_gripper_left-val ((m <cwru_baxter_cart_moveResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cwru_action-msg:current_pose_gripper_left-val is deprecated.  Use cwru_action-msg:current_pose_gripper_left instead.")
  (current_pose_gripper_left m))
(cl:defmethod roslisp-msg-protocol:symbol-codes ((msg-type (cl:eql '<cwru_baxter_cart_moveResult>)))
    "Constants for message type '<cwru_baxter_cart_moveResult>"
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <cwru_baxter_cart_moveResult>) ostream)
  "Serializes a message object of type '<cwru_baxter_cart_moveResult>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <cwru_baxter_cart_moveResult>) istream)
  "Deserializes a message object of type '<cwru_baxter_cart_moveResult>"
    (cl:let ((unsigned 0))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<cwru_baxter_cart_moveResult>)))
  "Returns string type for a message object of type '<cwru_baxter_cart_moveResult>"
  "cwru_action/cwru_baxter_cart_moveResult")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'cwru_baxter_cart_moveResult)))
  "Returns string type for a message object of type 'cwru_baxter_cart_moveResult"
  "cwru_action/cwru_baxter_cart_moveResult")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<cwru_baxter_cart_moveResult>)))
  "Returns md5sum for a message object of type '<cwru_baxter_cart_moveResult>"
  "9a149276118a7ea8a4cf40c0176ca433")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'cwru_baxter_cart_moveResult)))
  "Returns md5sum for a message object of type 'cwru_baxter_cart_moveResult"
  "9a149276118a7ea8a4cf40c0176ca433")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<cwru_baxter_cart_moveResult>)))
  "Returns full string definition for message of type '<cwru_baxter_cart_moveResult>"
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%#result definition~%#  response codes...~%uint8 ARM_STATUS_UNDEFINED=0~%uint8 ARM_RECEIVED_AND_INITIATED_RQST=1~%uint8 ARM_REQUEST_REJECTED_ALREADY_BUSY=2~%uint8 ARM_SERVER_NOT_BUSY=3~%uint8 ARM_SERVER_IS_BUSY=4~%uint8 ARM_RECEIVED_AND_COMPLETED_RQST=5~%uint8 RT_ARM_PATH_IS_VALID=6~%uint8 RT_ARM_PATH_NOT_VALID=7~%~%uint8 COMMAND_CODE_NOT_RECOGNIZED=8~%uint8 SUCCESS=9~%uint8 NOT_FINISHED_BEFORE_TIMEOUT=10~%int32 return_code~%int32 err_code~%string err_msg~%float64 computed_arrival_time~%float64[] q_arm_right~%float64[] q_arm_left~%geometry_msgs/PoseStamped current_pose_gripper_right~%geometry_msgs/PoseStamped current_pose_gripper_left~%~%================================================================================~%MSG: geometry_msgs/PoseStamped~%# A Pose with reference coordinate frame and timestamp~%Header header~%Pose pose~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of postion and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'cwru_baxter_cart_moveResult)))
  "Returns full string definition for message of type 'cwru_baxter_cart_moveResult"
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%#result definition~%#  response codes...~%uint8 ARM_STATUS_UNDEFINED=0~%uint8 ARM_RECEIVED_AND_INITIATED_RQST=1~%uint8 ARM_REQUEST_REJECTED_ALREADY_BUSY=2~%uint8 ARM_SERVER_NOT_BUSY=3~%uint8 ARM_SERVER_IS_BUSY=4~%uint8 ARM_RECEIVED_AND_COMPLETED_RQST=5~%uint8 RT_ARM_PATH_IS_VALID=6~%uint8 RT_ARM_PATH_NOT_VALID=7~%~%uint8 COMMAND_CODE_NOT_RECOGNIZED=8~%uint8 SUCCESS=9~%uint8 NOT_FINISHED_BEFORE_TIMEOUT=10~%int32 return_code~%int32 err_code~%string err_msg~%float64 computed_arrival_time~%float64[] q_arm_right~%float64[] q_arm_left~%geometry_msgs/PoseStamped current_pose_gripper_right~%geometry_msgs/PoseStamped current_pose_gripper_left~%~%================================================================================~%MSG: geometry_msgs/PoseStamped~%# A Pose with reference coordinate frame and timestamp~%Header header~%Pose pose~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of postion and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <cwru_baxter_cart_moveResult>))
  (cl:+ 0
     4
     4
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <cwru_baxter_cart_moveResult>))
  "Converts a ROS message object to a list"
  (cl:list 'cwru_baxter_cart_moveResult
