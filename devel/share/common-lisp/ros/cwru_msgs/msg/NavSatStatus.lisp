...
(cl:defmethod cl:initialize-instance :after ((m <NavSatStatus>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'NavSatStatus)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cwru_msgs-msg:<NavSatStatus> is deprecated: use cwru_msgs-msg:NavSatStatus instead.")))
...
(cl:defmethod service-val ((m <NavSatStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cwru_msgs-msg:service-val is deprecated.  Use cwru_msgs-msg:service instead.")
  (service m))
