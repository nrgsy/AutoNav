...
(cl:defmethod cl:initialize-instance :after ((m <VecOfDoubles>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'VecOfDoubles)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cwru_msgs-msg:<VecOfDoubles> is deprecated: use cwru_msgs-msg:VecOfDoubles instead.")))

(cl:ensure-generic-function 'dbl_vec-val :lambda-list '(m))
(cl:defmethod dbl_vec-val ((m <VecOfDoubles>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cwru_msgs-msg:dbl_vec-val is deprecated.  Use cwru_msgs-msg:dbl_vec instead.")
  (dbl_vec m))
