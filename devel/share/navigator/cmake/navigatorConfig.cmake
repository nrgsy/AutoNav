...
if("TRUE" STREQUAL "TRUE")
  set(navigator_SOURCE_PREFIX /home/thomas/ros_ws/src/learning_ros/Part_4/navigator)
  set(navigator_DEVEL_PREFIX /home/thomas/ros_ws/devel)
  ...
  set(navigator_INSTALL_PREFIX /home/thomas/ros_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'navigator' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'wyatt <wyatt@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'navigator' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/thomas/ros_ws/src/learning_ros/Part_4/navigator/${idir}'.  Ask the maintainer 'wyatt <wyatt@todo.todo>' to fix it.")
    endif()
...
set(navigator_EXPORTED_TARGETS "navigator_generate_messages_cpp;navigator_generate_messages_lisp;navigator_generate_messages_py")
...
set(depends "message_runtime;roscpp;std_msgs;geometry_msgs;nav_msgs;traj_builder;actionlib")
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${navigator_dep}_FOUND)
      find_package(${navigator_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${navigator_dep} REQUIRED ${depend_list})
  endif()
