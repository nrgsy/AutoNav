...
if("TRUE" STREQUAL "TRUE")
  set(openslam_gmapping_SOURCE_PREFIX /home/thomas/ros_ws/src/student_code/openslam_gmapping)
  set(openslam_gmapping_DEVEL_PREFIX /home/thomas/ros_ws/devel)
  ...
  set(openslam_gmapping_INSTALL_PREFIX /home/thomas/ros_ws/install)
...
if(NOT "/home/thomas/ros_ws/src/student_code/openslam_gmapping/include " STREQUAL " ")
  set(openslam_gmapping_INCLUDE_DIRS "")
  set(_include_dirs "/home/thomas/ros_ws/src/student_code/openslam_gmapping/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'openslam_gmapping' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Vincent Rabaud <vincent.rabaud@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'openslam_gmapping' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/thomas/ros_ws/src/student_code/openslam_gmapping/${idir}'.  Ask the maintainer 'Vincent Rabaud <vincent.rabaud@gmail.com>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${openslam_gmapping_dep}_FOUND)
      find_package(${openslam_gmapping_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${openslam_gmapping_dep} REQUIRED ${depend_list})
  endif()
