...
if("TRUE" STREQUAL "TRUE")
  set(custom_msgs_SOURCE_PREFIX /home/thomas/ros_ws/src/learning_ros/Part_1/custom_msgs)
  set(custom_msgs_DEVEL_PREFIX /home/thomas/ros_ws/devel)
  ...
  set(custom_msgs_INSTALL_PREFIX /home/thomas/ros_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'custom_msgs' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'wyatt <wyatt@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'custom_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/thomas/ros_ws/src/learning_ros/Part_1/custom_msgs/${idir}'.  Ask the maintainer 'wyatt <wyatt@todo.todo>' to fix it.")
    endif()
...
set(custom_msgs_EXPORTED_TARGETS "custom_msgs_generate_messages_cpp;custom_msgs_generate_messages_lisp;custom_msgs_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${custom_msgs_dep}_FOUND)
      find_package(${custom_msgs_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${custom_msgs_dep} REQUIRED ${depend_list})
  endif()
